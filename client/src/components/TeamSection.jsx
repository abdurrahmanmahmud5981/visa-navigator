...
const TeamSection = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1633332755192-727a05c4013d?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDF8fHxlbnwwfHx8fHw%3D",
        ...
        <Slide direction="up" triggerOnce>
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">
              Our Leadership <span className="text-primary">Team</span>
            </h2>
